...
const I18N = {
  ...
  dict: {
    de: {
      ...
      "auth.consent": "Ich bin mind. 16 Jahre alt und akzeptiere die <button type=\"button\" class=\"link-btn\" data-legal=\"privacy\">Datenschutzerklärung</button>.",
      "auth.needConsent": "Bitte bestätige das Mindestalter und die Datenschutzerklärung.",
      "legal.imprint": "Impressum",
      "legal.privacy": "Datenschutz",
      "legal.open": "Impressum & Datenschutz",
      "del.open": "Konto löschen",
      "del.confirm": "Dein Konto und ALLE deine Daten (Beiträge, Fotos, Likes, Kommentare) werden unwiderruflich gelöscht. Fortfahren?",
      "del.done": "Dein Konto wurde gelöscht. Alles Gute! 👋",
      ...
      "fb.open": "App verbessern",
      "fb.title": "💡 App verbessern",
      "fb.desc": "Was würdest du an SideQuest verbessern? Idee, Fehler oder Wunsch – alles hilft!",
      "fb.ph": "Deine Idee oder dein Feedback…",
      "fb.send": "Senden",
      "fb.thanks": "Danke für dein Feedback! 💜",
      ...
      "up.captionPh": "Beschreibung… (@Name zum Erwähnen)",
      ...
      "adm.archiveTitle": "📜 Archiv-Anzeige",
      "adm.cfgHourly": "Stunden-Challenges",
      "adm.cfgDaily": "Tages-Challenges",
      "adm.save": "Speichern",
      "adm.saved": "Gespeichert ✓",
      "adm.resetTitle": "⚠️ Zurücksetzen",
      "adm.wipe": "Alle Beiträge & Fotos löschen",
      "adm.wipeConfirm": "Wirklich ALLE Beiträge und Fotos aller Nutzer löschen? Das kann nicht rückgängig gemacht werden.",
      "adm.wiped": "Alle Beiträge wurden gelöscht.",
    ...
    en: {
      ...
      "auth.consent": "I am at least 16 years old and accept the <button type=\"button\" class=\"link-btn\" data-legal=\"privacy\">privacy policy</button>.",
      "auth.needConsent": "Please confirm the minimum age and the privacy policy.",
      "legal.imprint": "Imprint",
      "legal.privacy": "Privacy",
      "legal.open": "Imprint & Privacy",
      "del.open": "Delete account",
      "del.confirm": "Your account and ALL your data (posts, photos, likes, comments) will be permanently deleted. Continue?",
      "del.done": "Your account has been deleted. Take care! 👋",
      ...
      "fb.open": "Improve the app",
      "fb.title": "💡 Improve the app",
      "fb.desc": "What would you improve about SideQuest? Idea, bug or wish – it all helps!",
      "fb.ph": "Your idea or feedback…",
      "fb.send": "Send",
      "fb.thanks": "Thanks for your feedback! 💜",
      ...
      "up.captionPh": "Caption… (@name to mention)",
      ...
      "adm.archiveTitle": "📜 Archive display",
      "adm.cfgHourly": "Hourly challenges",
      "adm.cfgDaily": "Daily challenges",
      "adm.save": "Save",
      "adm.saved": "Saved ✓",
      "adm.resetTitle": "⚠️ Reset",
      "adm.wipe": "Delete all posts & photos",
      "adm.wipeConfirm": "Really delete ALL posts and photos from all users? This cannot be undone.",
      "adm.wiped": "All posts have been deleted.",
